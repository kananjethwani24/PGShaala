...
const Auth = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    if (email === 'demo@pgshaala.com') await ensureDemoAccount();
      ...
      <div className="hidden lg:flex w-1/2 relative overflow-hidden flex-col justify-between p-12" style={{ background: 'hsl(220, 16%, 8%)' }}>
        <div className="relative z-10">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="font-display font-bold text-lg text-white tracking-tight">PGShaala</h1>
        ...
        <p className="relative z-10 text-[10px] text-white/20">© 2026 PGShaala. All rights reserved.</p>
      ...
      <div className="flex-1 flex items-center justify-center p-6">
        ...
        >
          <div className="lg:hidden flex items-center gap-2.5 mb-10">
            ...
            <h1 className="font-display font-bold text-base text-foreground tracking-tight">PGShaala</h1>
          </div>
          ...
          <p className="text-xs text-muted-foreground mb-8">
            {mode === 'login' ? 'Sign in to your CRM dashboard' : mode === 'signup' ? 'Join your team on PGShaala' : 'Enter your email to reset password'}
          </p>
